                            ...
                            <TableRow key={booking.id}>
                                ...
                                <TableCell>
                                    <div className="flex flex-col gap-1">
                                        {booking.uploads && booking.uploads.length > 0 && booking.uploads[0].leave_form ? (
                                        ...
                                        {booking.uploads && booking.uploads.length > 0 && booking.uploads[0].passengers ? (
                                        ...
                                        {booking.uploads && booking.uploads.length > 0 && booking.uploads[0].drivers ? (
